# 👋 Hi, I'm Manjot Bhathal

I'm a recent graduate from UNSW with a **Bachelor of Actuarial Studies (Risk Management & Analytics)** and **Bachelor of Computer Science (Artificial Intelligence)**.

I’m passionate about using data, technology, and actuarial thinking to solve real-world problems — whether it’s through financial modelling, machine learning, or web app development.

---

## 💼 Experience Highlights

- 🧠 **Actuarial Modelling & Data Science:**  
  Created interpretable insurance pricing models (GLMs, EBM) and performed clustering and PCA on real-world datasets.

- 🧮 **Financial Risk & Restructuring:**  
  Worked with KPMG's Turnaround & Restructuring team, investigating insolvent entities and managing conflicting stakeholder interests.

- 💻 **Software & AI Development:**  
  Built web applications and backend systems using Python, JavaScript, Flask, and React. Developed intelligent agents and simulations in academic and practical projects.
...
- **Tools:** Flask, React, Git, Excel, PostgreSQL
- **Domains:** Insurance pricing, Restructuring, Web Development, AI, Health Economics

---

## 📫 Let's Connect

- 💼 [LinkedIn](https://www.linkedin.com/in/manjotbhathal/)
- 📧 manjot.b2003@gmail.com
